...
/* @var $model rabint\form\models\search\DefaultSearch */
...
<div class="card block block-rounded block-mode-loading-refresh">
    ...
    <div class="card-body block-content bg-body-light" style="display: none;">
        <div class="search_box form-search">
            <div class="row">
                <div class="col-sm-4"><?= $form->field($model, 'id') ?></div>

                <div class="col-sm-4"><?= $form->field($model, 'slug') ?></div>

                <div class="col-sm-4"><?= $form->field($model, 'title') ?></div>

                <div class="col-sm-4"><?= $form->field($model, 'status') ?></div>

                <div class="col-sm-4"><?= $form->field($model, 'publish_at') ?></div>

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'expire_at') ?></div>-->

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'max_duration') ?></div>-->

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'access_type') ?></div>-->

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'access_password_hash') ?></div>-->

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'price') ?></div>-->

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'description') ?></div>-->

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'form_limit') ?></div>-->

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'from_reserve') ?></div>-->

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'type') ?></div>-->

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'class_options') ?></div>-->

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'part_options') ?></div>-->

                <!--<div class="col-sm-4"><?php // echo $form->field($model, 'result_options') ?></div>-->
