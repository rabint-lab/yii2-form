...
use rabint\form\models\Form;

/**
 * DefaultSearch represents the model behind the search form about `rabint\form\models\Form`.
 */
class DefaultSearch extends Form
{
    ...
    {
        return [
            [['id', 'status', 'publish_at', 'expire_at', 'max_duration', 'price', 'form_limit', 'from_reserve', 'created_at', 'updated_at', 'created_by', 'updated_by'], 'integer'],
            [['slug', 'title', 'access_type', 'access_password_hash', 'description', 'type', 'class_options', 'part_options', 'result_options'], 'safe'],
    ...
    public function search($params,$returnActiveQuery = FALSE)
    {
        ...
        $query->andFilterWhere([
            ...
            'price' => $this->price,
            'form_limit' => $this->form_limit,
            'from_reserve' => $this->from_reserve,
        ...
        $query->andFilterWhere(['like', 'slug', $this->slug])
            ...
            ->andFilterWhere(['like', 'access_password_hash', $this->access_password_hash])
            ->andFilterWhere(['like', 'description', $this->description])
            ->andFilterWhere(['like', 'type', $this->type])
            ->andFilterWhere(['like', 'class_options', $this->class_options])
            ->andFilterWhere(['like', 'part_options', $this->part_options])
            ->andFilterWhere(['like', 'result_options', $this->result_options]);
